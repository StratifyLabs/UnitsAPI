...
UNITS_DECLARE_DERIVED_UNIT(ElectricResistance,ohm,Omega);
...
UNITS_DECLARE_DERIVED_UNIT(AngularAcceleration,radian per second squared,rad/s^2);
...
UNITS_DECLARE_DERIVED_UNIT(SpecificHeatCapacity,joule per kilogram kelvin,J/(kg*K));
UNITS_DECLARE_DERIVED_UNIT(SpecificEnergy,joule per kilogram,J/kg);
UNITS_DECLARE_DERIVED_UNIT(ThermalConductivity,watt per meter kelvin,W/(m*K));
...
UNITS_DECLARE_DERIVED_UNIT(ElectricChargeDensity,coulomb per cubic meter,C/m^3);
UNITS_DECLARE_DERIVED_UNIT(ElectricFluxDensity,coulomb per square meter,C/m^2);
...
UNITS_DECLARE_DERIVED_UNIT(MolarHeatCapacity,joule per mole kelvin,J/(mol*K));

UNITS_DECLARE_DERIVED_UNIT(Radiance,watt per square meter steradian,W/(m^2*sr));
...
//UNITS_DECLARE_DIVIDE(SpecificHeatCapacity,Energy,Mass * ThermodynamicTemperature);
UNITS_DECLARE_DIVIDE(SpecificEnergy,Energy,Mass);
//UNITS_DECLARE_DIVIDE(ThermalConductivity,Power,Length * ThermodynamicTemperature);
...
//UNITS_DECLARE_DIVIDE(MolarHeatCapacity,Energy,AmountOfSubstance * ThermodynamicTemperature);
