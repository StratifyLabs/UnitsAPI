...
Energy get_potential_energy(Mass mass, Length height, Acceleration acceleration = gravity());
...
//angular momentum is also cross of rotational inertia and angular velocity (extended)
//Work is dot product of F and S (displacement)
